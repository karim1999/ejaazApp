    ...
    addOrEdit(){
        ...
        return AsyncStorage.getItem('token').then(userToken => {
            ...
            if(this.state.data.isEducation){
                ...
                return axios.post(Server.url + 'api/editEducation'+this.state.data.education_id+'?token='+userToken, data)
                .then(response => {
                    this.setState({
                        isLoading: false,
                    });
                    this.props.navigation.navigate("Education", {...this.state.data});
                    if(this.state.data.isEducation){
                        Toast.show({
            ...
            {
                return axios.post(Server.url + 'api/addEducation?token='+userToken, data)
                .then(response => {                    
                        Toast.show({
